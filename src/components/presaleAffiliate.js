...
const PresaleAffiliate = ({ initialText, expandedText }) => {
        ...
        <>
            <div className="" id='presaleBox'>
                ...
                <div className=" mt-3">
                    ...
                    <div className="bigBtn a_btns text-center mt-3 d-flex justify-content-center">
                        {
                            account ? (null) :
                                (<button className="mybtn d-flex gap-2 align-items-center" onClick={onConnect}>
...
export default PresaleAffiliate;