...
const ROADMAP_ITEMS = [
  ...
  { date: '2026', title: 'Exchange listings, liquidity expansion, market making, community growth', description: 'Major exchange listings, expanding liquidity, market making initiatives, and community growth.', status: 'in-progress', isActive: true },
  { date: '2026', title: 'MVP Beta launch (Telemedicine pilot)', description: 'Onboarding of medical professionals, and first real-world consultations.' },
